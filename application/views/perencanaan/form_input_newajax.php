	...
	<div class="card mb-4">
		...
		<div class="card-body">
			...
			<div class="card-body">
				...
				<form id="inputperencanaan" enctype='multipart/form-data'>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9">
							<input name="judul_kegiatan" type="text" class="form-control mb-1" placeholder="Judul Kegiatan"
								value="<?=isset($edit["judul_kegiatan"]) ? set_value("judul_kegiatan", $edit["judul_kegiatan"]): set_value("judul_kegiatan"); ?>" required="required">
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9">
							<input name="uraian_kegiatan" type="text" class="form-control mb-1"
								...
								value="<?=isset($edit["uraian_kegiatan"]) ? set_value("uraian_kegiatan", $edit["uraian_kegiatan"]): set_value("uraian_kegiatan"); ?>" required="required">
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9">
							<input name="tanggal_kegiatan" type="date" class="form-control mb-1"
								...
								value="<?=isset($edit["tanggal_kegiatan"]) ? set_value("tanggal_kegiatan", $edit["tanggal_kegiatan"]): set_value("tanggal_kegiatan"); ?>" required="required">
						</div>
					</div>
					...
					<div class="row mb-3">
						...
						<div class="col-sm-9">
							<input name="foto" class="form-control" type="file" id="formFile" placeholder="foto"
								value="<?=isset($edit["foto"]) ? set_value("foto", $edit["foto"]): set_value("foto"); ?>" required="required">
						</div>
					</div>
