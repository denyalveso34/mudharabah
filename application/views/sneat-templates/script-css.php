...
<link rel="stylesheet" href="<?=$this->config->item('vendor-libs').'datatables-bs5/datatables.bootstrap5.css';?>">
<link rel="stylesheet" href="<?=$this->config->item('vendor-libs').'datatables-responsive-bs5/responsive.bootstrap5.css';?>">
<link rel="stylesheet" href="<?=$this->config->item('vendor-libs').'datatables-checkboxes-jquery/datatables.checkboxes.css';?>">
